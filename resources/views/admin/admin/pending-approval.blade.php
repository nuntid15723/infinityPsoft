            ...
            <div class="card" style="margin: 20px">
                <div class="card-body ">
                    <div class="active-member ">
                        <div class="table-responsive ">
                            <table class="table table-xs mb-0" style="font-family: 'Prompt', sans-serif; font-weight:400;">
                                <thead>
                                    <tr>
                                        <th scope="col"
                                            style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">#</th>
                                        <th scope="col"
                                            style="font-family: 'Kanit', sans-serif; font-weight:600; color:#164176">ชื่อ
                                        </th>
                                        <th scope="col"
                                            style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">แผนก
                                        </th>
                                        <th scope="col"
                                            style="font-family: 'Kanit', sans-serif; font-weight:600; color:#164176">
                                            วันที่ลา</th>
                                        <th scope="col"
                                            style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">
                                            วันที่สิ้นสุด</th>
                                        <th scope="col"
                                            style=" text-align: center; font-family: 'Kanit', sans-serif; font-weight:600; color:#164176; width: 185px; ">
                                            สถานะการลา</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="row">
                                            <div class="card btn"
                                                style="background-image: linear-gradient(230deg, #C6F6CB, #06C360,#1CF38C ); margin-bottom: 1px;white:100px; padding: 4px 22px;">
                                            ...
                                            <div class="card btn" style="background-image: linear-gradient(230deg, #F8A8FF, #FD6585, #FC76A3 ); margin-bottom: 1px;margin-left: 28px; width: 93px;
                                                            padding: 4px 18px;
                                                          ">
                        ...
                        <nav aria-label="Page navigation example" style="float: right; margin-right: 50px;">
                            <ul class="pagination">
                                <li class="page-item">
