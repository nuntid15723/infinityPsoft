                            ...
                            <table class="table table-xs mb-0" style="font-family: 'Prompt', sans-serif; font-weight:400;">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="font-family: 'Kanit', sans-serif; font-weight:600; color:#164176">ชื่อ
                                        </th>
                                        <th style="font-family: 'Kanit', sans-serif; font-weight:600; color:#FFD027">แผนก
                                        </th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="card"
                                                style="background-image: linear-gradient(230deg, #F8A8FF, #FD6585, #FC76A3 ); margin-bottom: 1px; font-family: 'Kanit', sans-serif; font-weight:600;">

                                                <div class="d-inline-block" style="margin: auto;margin-top: 5px;">
                                                    <h4 class="text-white " style="text-align: center;">ไม่อนุมัติ</h4>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="card"
                                                style="background-image: linear-gradient(230deg, #F8A8FF, #FD6585, #FC76A3 ); margin-bottom: 1px; margin-bottom: 1px; font-family: 'Kanit', sans-serif; font-weight:600;">
