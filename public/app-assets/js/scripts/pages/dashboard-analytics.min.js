$(window).on("load", function () {
    ...
    var l = {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    value: { offsetY: 30, color: "#99a2ac", fontSize: "2rem" },
                },
            },
        },
        colors: [t],
    ...
    var c = {
        ...
        dataLabels: { style: { colors: [o, o, o, o, o, o] } },
        yaxis: { show: !1 },
        grid: { show: !1 },
    };
    ...
    p.addStep("step-1", {
        ...
        1200 < $(window).width() && !$("body").hasClass("menu-collapsed")
            ? p.start()
            : p.cancel(),
        $("body").hasClass("horizontal-menu") && p.cancel(),
