$(document).ready(function () {
    var l = {
        ...
        columnDefs: [
            ...
            { headerName: "Name", field: "name", filter: !0, width: 200 },
            { headerName: "Country", field: "country", filter: !0, width: 150 },
            { headerName: "Role", field: "role", filter: !0, width: 150 },
            {
                headerName: "Status",
                field: "status",
                filter: !0,
            ...
            },
            {
                ...
                cellRenderer: function (e) {
                    ...
                    return (
                        (a.value = "users-delete-icon feather icon-trash-2"),
                        i.setAttributeNode(a),
                        i.addEventListener("click", function () {
                            (deleteArr = [e.data]),
                                l.api.updateRowData({ remove: deleteArr });
                        }),
                        t.appendChild(
                            $.parseHTML(
    ...
    if (document.getElementById("myGrid")) {
        var e = document.getElementById("myGrid");
        agGrid
            .simpleHttpRequest({
            ...
            $(".ag-grid-filter").on("keyup", function () {
                !(function (e) {
                    l.api.setQuickFilter(e);
                })($(this).val());
            }),
            $(".sort-dropdown .dropdown-item").on("click", function () {
                var e = $(this);
                !(function (e) {
                    l.api.paginationSetPageSize(Number(e));
                })(e.text()),
                    $(".filter-btn").text("1 - " + e.text() + " of 50");
            }),
            $(".ag-grid-export-btn").on("click", function (e) {
                l.api.exportDataAsCsv();
            });
        function t(e, t) {
            var i = null;
            "all" !== t && (i = { type: "equals", filter: t }),
                l.api.getFilterInstance(e).setModel(i),
    ...
    0 < $("#users-language-select2").length &&
        $("#users-language-select2").select2({
            dropdownAutoWidth: !0,
            width: "100%",
        }),
        0 < $("#users-music-select2").length &&
            $("#users-music-select2").select2({
                dropdownAutoWidth: !0,
                width: "100%",
            }),
        0 < $("#users-movies-select2").length &&
            $("#users-movies-select2").select2({
                dropdownAutoWidth: !0,
                width: "100%",
            }),
        0 < $(".birthdate-picker").length &&
            $(".birthdate-picker").pickadate({ format: "mmmm, d, yyyy" }),
        0 < $(".users-edit").length &&
