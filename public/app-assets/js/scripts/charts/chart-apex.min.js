$(document).ready(function () {
    ...
    new ApexCharts(document.querySelector("#column-chart"), o).render();
    var i = {
        chart: { height: 350, type: "bar" },
        colors: t,
    ...
    new ApexCharts(document.querySelector("#mixed-chart"), s).render();
    var d = {
        ...
        xaxis: { type: "datetime" },
        yaxis: { tickAmount: 5, tooltip: { enabled: !0 }, opposite: a },
    };
    function c(e, t, a) {
        for (var r = 0, n = []; r < t; ) {
    ...
    new ApexCharts(document.querySelector("#candlestick-chart"), d).render();
    var l = {
        ...
        series: [
            {
                name: "Product1",
                data: c(new Date("11 Feb 2017 GMT").getTime(), 20, {
                    min: 10,
                    max: 60,
                }),
            },
        ...
        yaxis: { max: 70, tickAmount: 5, opposite: a },
        theme: { palette: "palette2" },
    };
    new ApexCharts(document.querySelector("#bubble-chart"), l).render();
    var y = {
        chart: {
            height: 350,
            type: "scatter",
        ...
        legend: { offsetY: -10 },
        xaxis: { tickAmount: 10 },
        yaxis: { tickAmount: 7, opposite: a },
    };
    new ApexCharts(document.querySelector("#scatter-chart"), y).render();
    var m = {
    ...
    new ApexCharts(document.querySelector("#pie-chart"), m).render();
    var x = {
    ...
    new ApexCharts(document.querySelector("#donut-chart"), x).render();
    var h = {
    ...
    new ApexCharts(document.querySelector("#radial-bar-chart"), h).render();
    var p = {
        chart: { height: 350, type: "radar" },
        colors: t,
        series: [{ name: "Series 1", data: [80, 50, 30, 40, 100, 20] }],
        labels: ["January", "February", "March", "April", "May", "June"],
        dataLabels: { style: { color: "#dae1e7" } },
    };
    function w(e, t) {
        for (var a = 0, r = []; a < e; ) {
    ...
    new ApexCharts(document.querySelector("#radar-chart"), p).render();
    var u = {
        chart: { height: 350, type: "heatmap" },
        dataLabels: { enabled: !1 },
        colors: [e],
        series: [
            { name: "Metric1", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric2", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric3", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric4", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric5", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric6", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric7", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric8", data: w(18, { min: 0, max: 90 }) },
            { name: "Metric9", data: w(18, { min: 0, max: 90 }) },
        ],
        yaxis: { opposite: a },
    };
    new ApexCharts(document.querySelector("#heat-map-chart"), u).render();
});
